    ...
    <footer style={{ background: 'var(--warmblack)', borderTop: '1px solid rgba(201,169,102,0.1)' }}>
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              AIO Solutions (Alpha Omega Solutions) — AI-powered websites, apps, lead automation, and custom integrations for forward-thinking businesses.
            </p>
      ...
      <div style={{ borderTop: '1px solid rgba(201,169,102,0.08)' }}>
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          >
            © {new Date().getFullYear()} AIO Solutions · All rights reserved
          </p>
